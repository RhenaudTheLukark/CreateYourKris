...
animations = {
    ...
    Defend =        { { 0, 1, 2, 3, 4, 5 },                                                     1 / 15, { loop = "ONESHOT", targetShift = { -7, -20 } }, true },
    ...
    Idle =          { { 0, 1, 2, 3 },                                                           2 / 15, { targetShift = { -7, -20 } },                   true },
    Intro =         { { 0, 1, 2, 3, 4, 5, 5, 5, 1 },                                            1 / 15, { next = "Idle" }                                     },
    Item =          { { 0, 1, 2, 3, 4 },                                                        2 / 15, { next = "Idle" }                                     },
    Magic =         { { 0, 1, 2, 3, 4, 5, 6, 7, 8 },                                            1 / 15, { next = "Idle" }                                     },
    PrepareAct =    { { 0 },                                                                    1,      { loop = "ONESHOT" },                            true },
    PrepareFight =  { { 0 },                                                                    1,      { loop = "ONESHOT" },                            true },
    PrepareItem =   { { 0, 1 },                                                                 2 / 15, { },                                             true },
    PrepareMagic =  { { 0, 1, 2, 3 },                                                           2 / 15, { },                                             true },
    PrepareSpare =  { { 0 },                                                                    1,      { loop = "ONESHOT" },                            true },
